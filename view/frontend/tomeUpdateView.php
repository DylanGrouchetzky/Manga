...
if (isset($_GET['id'])){
	...
	<form action="index.php?action=editTome" method="post">
		<table>
			<tr>
				<th><label for="name">Selectionner le Manga : </label></th>
				<th>
			...
			<tr>
				...
				<th><input type="text" name="newPicture" id="newPicture"></th>
			</tr>
			<tr>
...
while ($data = $nameManga->fetch()){
	?>
	<a href="index.php?action=updateTome&amp;id=<?= $data['ID'] ?>"><img src="public/image/<?= $data['picture'] ?>" class="thumbnail"></a>
	<?php
}
?>
</div>
